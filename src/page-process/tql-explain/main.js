    ...
    <div className="FBH group-explain">
      ...
      <div className="anchor-content markdown-body">
        <div>
          ...
          <p>
TQL（Tag Query Language）是标签查询语言，是一种基于业务逻辑模型的数据查询语言。标签查询语言与结构化查询语言（SQL）中的数据查询语言（DQL）类似，用以在业务逻辑模型之上从表中获得数据。TQL仅支持SELECT(不区分大小写)开头的语法，不支持 INSERT INTO、DELETE、UPDATE 等，常与WHERE，ORDER BY，GROUP BY等结合起来使用。语法上与mysql类似。
业务逻辑模型即标签体系，通过Object对象、tag标签将库表中的数据重新组织。
