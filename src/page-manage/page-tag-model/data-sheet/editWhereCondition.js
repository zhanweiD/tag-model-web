  ...
  render() {
    ...
    return (
      <Modal
        ...
        title={intl
          .get(
            'ide.src.page-manage.page-tag-model.data-sheet.editWhereCondition.xe0xza7r8gn'
          )
          .d('编辑关联表')}
          ...
          {+bothTypeCode === 2 ? (
            ...
            >
              {getFieldDecorator('mappingKey', {
                initialValue:
                  dataSheetDetail.mappingKeys &&
                  dataSheetDetail.mappingKeys.length === 1
                    ? [dataSheetDetail.mappingKeys[0].field_name]
                    : undefined,
                rules: [
                  {
                    required: true,
            ...
            <Fragment>
              ...
              >
                {getFieldDecorator('entity1Key', {
                  initialValue:
                    dataSheetDetail.mappingKeys &&
                    dataSheetDetail.mappingKeys.length === 2
                      ? dataSheetDetail.mappingKeys[0].field_name
                      : undefined,
                  rules: [
                    {
              ...
              >
                {getFieldDecorator('entity2Key', {
                  initialValue:
                    dataSheetDetail.mappingKeys &&
                    dataSheetDetail.mappingKeys.length === 2
                      ? dataSheetDetail.mappingKeys[1].field_name
                      : undefined,
                  rules: [
                    {
                      required: true,
